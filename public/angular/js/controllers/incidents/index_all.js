angular.module('Aggie')
  ...
  .controller('AllIncidentsIndexController', [
    ...
    'paginationOptions',
    'Tags',
    function($state, $scope, $rootScope, $stateParams, flash, incidents, reports, users, sources,
             incidentStatusOptions, veracityOptions, escalatedOptions, Incident,
             mediaOptions, Socket, Queue, paginationOptions, Tags) {
      ...
      $scope.reportsAttachedTo = function(incident) {
        return $scope.reports.filter(function(report) {
          return report._incident === incident._id;
        });
      };
